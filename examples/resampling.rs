...
fn main() {
    ...
    println!("> AudioContext sample_rate: {:?}", audio_context.sample_rate());
    ...
    println!("+ playing sample-38000.wav - decoded sample rate: {:?}", buffer_38000.sample_rate());
    ...
    println!("+ playing sample-44100.wav - decoded sample rate: {:?}", buffer_44100.sample_rate());
    let src = audio_context.create_buffer_source();
    src.connect(&audio_context.destination());
    ...
    println!("+ playing sample-48000.wav - decoded sample rate: {:?}", buffer_48000.sample_rate());
    let src = audio_context.create_buffer_source();
    src.connect(&audio_context.destination());
    ...
    println!("");
    println!("> Case 2:
        buffers are decoded with another sample rate,
        then resampled by the AudioBufferSourceNode");
    println!("");
    ...
    let file_38000 = File::open("samples/sample-38000.wav").unwrap();
    let buffer_38000 = audio_context_38000.decode_audio_data_sync(file_38000).unwrap();
    ...
    let file_44100 = File::open("samples/sample-44100.wav").unwrap();
    let buffer_44100 = audio_context_44100.decode_audio_data_sync(file_44100).unwrap();
    ...
    let file_48000 = File::open("samples/sample-48000.wav").unwrap();
    let buffer_48000 = audio_context_48000.decode_audio_data_sync(file_48000).unwrap();
